...
export default function Edit() {
    ...
    const onUpdate = () => {
        Axios.put(
            'https://a3-server-cs5610.herokuapp.com/url/' + shortenedURL,
            {
                original: newURL,
            }
        )
    ...
    return (
        <div className="customContainer editContainer">
            ...
            <button className="editItem" onClick={onUpdate}>
                Update
            </button>
            <button className="editItem" onClick={handleShow}>
                Delete
            </button>
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    You won't be able to use this link anymore.
                </Modal.Body>
                <Modal.Footer>
